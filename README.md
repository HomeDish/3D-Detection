...
python test.py --gpu_idx 0 --pretrained_path ../checkpoints/complexer_yolo/Model_complexer_yolo_epoch_10.pth --cfgfile ./config/cfg/complex_yolov4.cfg --show_image
```
...
python evaluate.py --gpu_idx 0 --pretrained_path ../checkpoints/complexer_yolo/Model_complexer_yolo_epoch_10.pth --cfgfile ./config/cfg/complex_yolov4.cfg
```
...
python train.py --gpu_idx 0 --batch_size 4 --num_workers 2 --num_epochs 100
